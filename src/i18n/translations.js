export const translations = {
  en: {
    ...
    hero: {
      ...
      description:
        "Frontend Developer with 3+ years of experience building web applications for external clients. Specialized in React & TypeScript.",
      cta: "Contact me",
      cv: "Download CV",
      cvFile: "/cv-BellidoLeonardo-en.pdf",
    },
    about: {
    ...
    experience: {
      ...
      title: "Experience",
      company: "Baufest · Argentina (remote)",
      role: "Frontend Developer",
  ...
  es: {
    ...
    hero: {
      ...
      role: "Frontend Developer",
      description:
        "Frontend Developer con +3 años de experiencia construyendo aplicaciones web para clientes externos. Especializado en React y TypeScript.",
      cta: "Contactame",
      cv: "Descargar CV",
      cvFile: "/cv-BellidoLeonardo-es.pdf",
    },
    about: {
    ...
    experience: {
      ...
      title: "Experiencia",
      company: "Baufest · Argentina (remoto)",
      role: "Frontend Developer",
    ...
    contact: {
      ...
      location: "Argentina — Disponible remoto",
    },
  },
};
